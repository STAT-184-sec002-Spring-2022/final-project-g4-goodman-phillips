...
author: "Morgan Goodman and Kristina Phillips"
...
(A) .Rmd Line numbers where at least two different data sources are imported:  23, 31


(B) .Rmd Line numbers for inspecting data intake:  24-27, 32-35


### Data Wrangling / Cleaning / ect (5 out of 7 required)


(A) .Rmd Line number(s) for general data wrangling: 60-63


(B) .Rmd Line number(s) for a join operation: 96-100


(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent): 52


(D) .Rmd Line number(s) for use of regular expressions: 87-89, 73


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 105-107, 69-73
...
(A) .Rmd Line numbers for use of multiple different geoms:  182, 170, 190

(B) .Rmd Line number(s) for use of multiple aesthetics: 200-201, 182, 

(C) .Rmd Line number(s) for use of layered graphics:  -----

(D) .Rmd Line number(s) for use of leaflet or choropleth maps:  115-162
