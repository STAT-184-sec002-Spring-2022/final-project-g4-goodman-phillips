...
(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent): 49-54


(D) .Rmd Line number(s) for use of regular expressions: 112-117


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 105-109
...
(A) .Rmd Line numbers for use of multiple different geoms:  169-173

(B) .Rmd Line number(s) for use of multiple aesthetics:  188-194

(C) .Rmd Line number(s) for use of layered graphics:  -----

(D) .Rmd Line number(s) for use of leaflet or choropleth maps:  121-126
